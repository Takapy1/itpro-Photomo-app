...
class ViewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create viewer" do
    assert_difference('Viewer.count') do
      post viewers_url, params: { viewer: { age: @viewer.age, gender: @viewer.gender, name: @viewer.name } }
    end
  ...
  test "should update viewer" do
    patch viewer_url(@viewer), params: { viewer: { age: @viewer.age, gender: @viewer.gender, name: @viewer.name } }
