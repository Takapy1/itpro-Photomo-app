...
class PhotographersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create photographer" do
    assert_difference('Photographer.count') do
      post photographers_url, params: { photographer: { age: @photographer.age, camera: @photographer.camera, category: @photographer.category, gender: @photographer.gender, name: @photographer.name } }
    end
  ...
  test "should update photographer" do
    patch photographer_url(@photographer), params: { photographer: { age: @photographer.age, camera: @photographer.camera, category: @photographer.category, gender: @photographer.gender, name: @photographer.name } }
